        ...
        if (ingredients.Length > 1) {
            ...
            if (timeleft < 0)
            {
                if (distances[0] < distances[1])
                {
                    ...
                    ingredients[0].gameObject.GetComponent<MeshRenderer>().material = BurntMeat;
                }
                else
                {
                    ingredients[1].gameObject.GetComponent<MeshRenderer>().material = BurntMeat;
                }
            }
            else if (timeleft < 60)
            {
                if (distances[0] < distances[1])
                {
                    ...
                    ingredients[0].gameObject.GetComponent<MeshRenderer>().material = DoneMeat;
                }
                else
                {
                    ingredients[1].gameObject.GetComponent<MeshRenderer>().material = DoneMeat;
                }
            }
